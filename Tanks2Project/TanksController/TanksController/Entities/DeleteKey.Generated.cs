...
{
    public partial class DeleteKey : FlatRedBall.PositionedObject, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public DeleteKey (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public DeleteKey (string contentManagerName, bool addToManagers) 
        	: base()
        {
        ...
        public virtual void PostInitialize () 
        {
            ...
            TextInstance.DisplayText = "BACKSPACE";
            ...
            AxisAlignedRectangleInstance.Width = 140f;
            AxisAlignedRectangleInstance.Height = 90f;
        ...
        public static void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("DeleteKeyStaticUnload", UnloadStaticContent);
